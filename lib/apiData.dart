...
getWeather({lat, long}) async {
  ...
  Uri url = Uri.parse(
      'https://api.weatherapi.com/v1/forecast.json?key=29af4524bc594271ba8222220233112&q=$lat,$long&aqi=yes&alerts=yes&days=2');
  var response;
  try {
...
void getWeatherFromName({city}) async {
  ...
  Map<String, dynamic> body = {};
  Uri url = Uri.parse(
      'https://api.weatherapi.com/v1/forecast.json?key=29af4524bc594271ba8222220233112&q=$city&aqi=yes&alerts=yes&days=2');
  var response;
  try {
    response = await http.get(url);
...
Future<dynamic> searchlocationNames({str}) async {
  ...
  Map<String, dynamic> body = {};
  Uri url = Uri.parse(
      'https://api.weatherapi.com/v1/search.json?key=29af4524bc594271ba8222220233112&q=$str');
  var response;
  try {
    response = await http.get(url);
  } on SocketException catch (e) {
...
Future<List> BackGroundWeather() async {
  ...
  Map<String, dynamic> body = {};
  Uri url = Uri.parse(
      'https://api.weatherapi.com/v1/forecast.json?key=29af4524bc594271ba8222220233112&q=$positionCord&alerts=yes&days=1');
  var response;
  try {
    response = await http.get(url);
  } on SocketException catch (e) {
